...
print("You understand that the Wizard's plan was to frame Pippin in order to get \
the Royal Guards off his trail and run back to his lair.")
print("Now you have to embark on a quest to help Pippin get out of the prison and \
