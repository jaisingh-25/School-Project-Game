...
print("You understand that the Wizard's plan was to frame Pippin in order to get the Royal Guards off his trail and run back to his lair.")
print("Now you have to embark on a quest to help Pippin get out of the prison and make sure that the evil Wizard is punished for his crimes.")
a=input("Please press the enter key to continue.")
print()
...
print()
print("As the Wizard is currently at the palace, you can look for clues regarding the Stolen Gem")
