...
while k=="No" :
    ...
    if k=="Yes" :
        ...
        while o!=2 :
            ...
            print("1. Try to look for some other bridge\n2. Try to fill Roman Numeral characters in the spaces")
            o=int(input())
            if o!=2 :
                print("Wrong answer, please try again")
        print("\nYou figured it out!\nThe inscription is a hint that instructs us how to cross the bridge.")
        ...
        print("You can guess the number 20 times before the password changes and you start over again.")
        a=input("Please press the enter key to start the game.")
        print()
        import random as ac
        z=0
